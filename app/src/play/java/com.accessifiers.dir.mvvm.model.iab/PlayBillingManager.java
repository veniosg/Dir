...
import static com.accessifiers.filebrowser.android.util.Logger.TAG_BILLING;
import static com.accessifiers.filebrowser.android.util.Logger.logV;
...
public class PlayBillingManager implements BillingManager {
                            ...
                            if (purchases != null) {
                                ...
                                for (Purchase p : purchases) {
                                    onPurchasedListener.onPurchased(
                                            new com.accessifiers.filebrowser.mvvm.model.iab.Purchase(p.getSku(),
                                                    p.getPurchaseToken()));
                                }
                            } else {
    ...
    @Override
    public void consumePurchase(com.accessifiers.filebrowser.mvvm.model.iab.Purchase p,
