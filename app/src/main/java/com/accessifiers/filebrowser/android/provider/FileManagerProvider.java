...
public class FileManagerProvider extends ContentProvider {
    public static final String FILE_PROVIDER_PREFIX = "content://com.accessifiers.filebrowser.filemanager";
    public static final String AUTHORITY = "com.accessifiers.filebrowser.filemanager";
