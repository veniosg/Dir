...
import static com.accessifiers.filebrowser.android.util.FileUtils.getFileName;
...
public class PathItemView extends FrameLayout {
    ...
    private void init() {
        ...
        mTextView.setTextAppearance(getContext(), R.style.TextAppearance_FileBrowser_Large);
