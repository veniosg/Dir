...
import com.accessifiers.filebrowser.mvvm.model.storage.operation.CompressOperation;
import com.accessifiers.filebrowser.mvvm.model.storage.operation.ExtractOperation;
...
import static com.accessifiers.filebrowser.mvvm.model.storage.operation.argument.CompressArguments.compressArgs;
import static com.accessifiers.filebrowser.mvvm.model.storage.operation.argument.ExtractArguments.extractArgs;
import static java.util.Collections.singletonList;

public class ZipService extends IntentService {
    private static final String ACTION_COMPRESS = "com.accessifiers.filebrowser.action.COMPRESS";
    private static final String ACTION_EXTRACT = "com.accessifiers.filebrowser.action.EXTRACT";
