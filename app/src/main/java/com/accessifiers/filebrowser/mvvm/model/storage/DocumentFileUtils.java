package com.accessifiers.filebrowser.mvvm.model.storage;
...
import static com.accessifiers.filebrowser.android.util.FileUtils.delete;
import static com.accessifiers.filebrowser.android.util.FileUtils.getExtSdCardPaths;
    ...
    private static Uri findStorageTreeUri(Context context, String storageRoot) {
        ...
        for (UriPermission permission : permissions) {
            if (permission.isWritePermission()) {
                ...
                List<String> storageRoots = getExtSdCardPaths(context);
