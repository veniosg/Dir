...
public class DeleteArguments extends FileOperation.Arguments {
    ...
    private DeleteArguments(@NonNull File parentDirectory, @NonNull FileHolder... victims) {
        super(parentDirectory);
        this.victims = victims;
    }

    public static DeleteArguments deleteArgs(@NonNull File parentDirectory, @NonNull FileHolder... victims) {
        return new DeleteArguments(parentDirectory, victims);
    }
