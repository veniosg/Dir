...
public class CreateDirectoryArguments extends FileOperation.Arguments {
    private CreateDirectoryArguments(@NonNull File newDirectory) {
        super(newDirectory);
    }

    public static CreateDirectoryArguments createDirectoryArguments(@NonNull File newDirectory) {
        return new CreateDirectoryArguments(newDirectory);
    }
}